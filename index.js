...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction can access internal b/c it's local to myFunction and a part of that closure. It can reach outside itself and use
// available varibles, etc..
  ...
  */
  ...
  function animalNames(arr){
    ...
    arr.forEach(function(item, index) {
      displayNames.push('name: ' + arr[index].animal_name + ', scientific: ' + arr[index].scientific_name);
    });
